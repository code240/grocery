...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Contact DailyBuyMart (Click here) : Daily buy mart provides you the best deals on all groceries products. Here you can find new offers daily. All groceries available here!">
    ...
    <title>Contact - Daily Buy Mart</title>
</head>
<body>
    ...
    <div class="contact-main">
        ...
        <div class="right-main-contact" id="contact">
            <h2 class="get-in-touch-heading">Get in touch</h2>
            <div class="form-div-in-contacts">
                <form action="backend/save_message.php" method="post" name="contact" onsubmit="return validation()">
                    <label for="name" class="name-label">Name: </label>
                    <input type="text" required name="name" id="name" autocomplete="off" class="input-name-inContact" placeholder="Name">
                    <label for="email" class="name-label">Email: </label>
                    <input type="email" required name="email" id="email" class="input-name-inContact" placeholder="Email Address">
                    <label for="subject"  class="name-label">Subject: </label>
                    <input type="text" required autocomplete="off" name="subject" id="subject" class="input-name-inContact" placeholder="Subject">
                    <label for="text-area" class="name-label">Your Message/Feedback: </label>
                    <textarea name="message" required id="textarea" class="input-name-inContact msg-textarea" placeholder="Your message / Feedback"></textarea>
                    <input type="submit" class="btn inp-submit" value="Send">
                </form>
            </div>
        </div>
        <div style="clear: both;"></div>
